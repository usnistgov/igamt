			...
			<xsl:element name="table">
				...
				<xsl:element name="thead">
					...
					<xsl:element name="tr">
						...
						<xsl:if test="$binding.includeBindingStrength ='true'">
							<xsl:element name="th">
								<xsl:text>Binding Strength</xsl:text>
							</xsl:element>
						</xsl:if>
						<xsl:if test="$binding.includeBindingLocation='true'">
							<xsl:element name="th">
								<xsl:text>Binding Location</xsl:text>
							</xsl:element>
						</xsl:if>
						<xsl:if test="$binding.includeSingleCode ='true'">
							<xsl:element name="th">
								<xsl:text>Single Code Value</xsl:text>
							</xsl:element>
						</xsl:if>
						<xsl:if test="$binding.includeSingleCodeSystem ='true'">
							<xsl:element name="th">
				...
				<xsl:element name="tbody">
					<xsl:for-each select="ValueSetBinding">
						<xsl:sort select="@SortLocation" data-type="number"
							order="ascending" />
						<xsl:element name="tr">
							<xsl:attribute name="class">
