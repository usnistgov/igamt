				...
				if (entry.getName().toLowerCase().equals("varies") && !exportConfig.isIncludeVaries()) {
					...
					if (compositeProfile != null) {
						serializableDatatype = serializeDatatypeService.serializeDatatype(entry,
								...
								compositeProfile.getDatatypesMap(), exportConfig.getIncludeAutoGenerated(), exportConfig.getBindingConfig());
					} else {
						if (datatype != null) {
							...
							serializableDatatype = serializeDatatypeService.serializeDatatype(entry,
									prefix + "." + String.valueOf(datatypeLinkList.indexOf(entry) + 1),
									datatypeLinkList.indexOf(entry), datatypeComponentsUsageConfig,exportConfig.getIncludeAutoGenerated(),exportConfig.getBindingConfig());
						}
					}
