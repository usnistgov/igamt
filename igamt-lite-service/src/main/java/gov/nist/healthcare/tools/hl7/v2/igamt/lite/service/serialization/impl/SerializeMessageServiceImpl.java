            ...
            for (SegmentRefOrGroup segmentRefOrGroup : message.getChildren()) {
                ...
                if (serializationLayout.equals(SerializationLayout.PROFILE)) {
                    serializeSegment(segmentRefOrGroup, messageSegments.getPrefix() + ".",
                        messageSegments, segmentOrGroupUsageConfig, segmentUsageConfig, fieldsUsageConfig, exportConfig.isGreyOutOBX2FlavorColumn(),exportConfig.getIncludeAutoGenerated(), exportConfig.getCoConstraintExportMode());
                }
            }
