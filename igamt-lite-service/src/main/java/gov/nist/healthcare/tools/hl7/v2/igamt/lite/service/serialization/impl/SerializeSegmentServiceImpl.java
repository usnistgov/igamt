...
@Service public class SerializeSegmentServiceImpl implements SerializeSegmentService {
    ...
    @Override public SerializableSection serializeSegment(SegmentLink segmentLink, String prefix,
        ...
        Map<String, Segment> compositeProfileSegments, Map<String, Datatype> compositeProfileDatatypes, Map<String, Table> compositeProfileTables, Boolean greyOutOBX2FlavorColumn,IncludeAutoGenerated includeDerived,CoConstraintExportMode coConstraintExportMode) throws SegmentSerializationException {
        Segment segment = compositeProfileSegments.get(segmentLink.getId());
        if(segment.isTemporary() && !includeDerived.segment){
        	return null;
        }
