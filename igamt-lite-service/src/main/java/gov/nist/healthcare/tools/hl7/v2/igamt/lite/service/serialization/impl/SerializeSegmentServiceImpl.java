...
@Service public class SerializeSegmentServiceImpl implements SerializeSegmentService {
    ...
    @Override
    public SerializableSection serializeSegment(SegmentLink segmentLink, String prefix, Integer position, Integer headerLevel, UsageConfig segmentUsageConfig, Boolean greyOutOBX2FlavorColumn,IncludeAutoGenerated includeAuto,CoConstraintExportMode coConstraintExportMode) throws SegmentSerializationException {
        Segment segment = segmentService.findById(segmentLink.getId());
        return this.serializeSegment(segment,prefix,position,headerLevel,segmentUsageConfig,null,null, false, greyOutOBX2FlavorColumn, null,includeAuto, coConstraintExportMode);
    }
    ...
    @Override public SerializableSection serializeSegment(SegmentLink segmentLink, String prefix,
        ...
        Map<String, Segment> compositeProfileSegments, Map<String, Datatype> compositeProfileDatatypes, Map<String, Table> compositeProfileTables, Boolean greyOutOBX2FlavorColumn,IncludeAutoGenerated includeAuto,CoConstraintExportMode coConstraintExportMode) throws SegmentSerializationException {
        Segment segment = compositeProfileSegments.get(segmentLink.getId());
        if(segment.isTemporary() && !includeAuto.segment){
        	return null;
        }
        return this.serializeSegment(segment,prefix,position,headerLevel,segmentUsageConfig,compositeProfileDatatypes,compositeProfileTables, false, greyOutOBX2FlavorColumn, null,includeAuto, coConstraintExportMode);
        }

    private SerializableSection serializeSegment(Segment segment, String prefix, Integer position, Integer headerLevel, UsageConfig fieldUsageConfig, Map<String, Datatype> compositeProfileDatatypes, Map<String, Table> compositeProfileTables, Boolean showInnerLinks, Boolean greyOutOBX2FlavorColumn, String host, IncludeAutoGenerated includeAuto,CoConstraintExportMode coConstraintExportMode) throws SegmentSerializationException {
        if (segment != null) {
            try {
                //Create section node
	...
	public SerializableSection serializeSegment(Segment segment, String host) throws SegmentSerializationException {
		...
		return serializeSegment(segment, String.valueOf(0), 1, 1, defaultConfig.getFieldsExport(), null, null, true, false, host,defaultConfig.getIncludeAutoGenerated(),defaultConfig.getCoConstraintExportMode());
	}
