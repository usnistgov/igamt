...
@Service public class SerializeDatatypeServiceImpl implements SerializeDatatypeService {
    ...
    public SerializableDatatype serializeDatatype(DatatypeLink datatypeLink, String prefix,
        Integer position, UsageConfig datatypeUsageConfig, IncludeAutoGenerated includeDerived, BindingExportConfig bindingExportConfig, Boolean includePrimitive) throws DatatypeSerializationException {
        if(datatypeLink!=null && datatypeLink.getId()!=null) {
            ...
            return serializeDatatype(datatype,headerLevel,prefix,position,datatypeUsageConfig, false,null,includeDerived, bindingExportConfig,includePrimitive,null);
        }
        return null;
    }
    ...
    public SerializableDatatype serializeDatatype(DatatypeLink datatypeLink, Datatype datatype, String prefix,
        ...
        if(datatype!=null) {
            String headerLevel = String.valueOf(3);
            return serializeDatatype(datatype,headerLevel,prefix,position,datatypeUsageConfig, false,null, new IncludeAutoGenerated(), new BindingExportConfig(), true,null);
        }
        return null;
    }
    ...
    public SerializableDatatype serializeDatatype(DatatypeLink datatypeLink, Datatype datatype, String prefix,
        Integer position, UsageConfig datatypeUsageConfig, IncludeAutoGenerated includeDerived, BindingExportConfig bindingExportConfig, Boolean includePrimitive) throws DatatypeSerializationException {
        if(datatype!=null) {
        	if(!includeDerived.datatype && datatype.isTemporary()){
            	return null;
            }
            String headerLevel = String.valueOf(3);
            return serializeDatatype(datatype,headerLevel,prefix,position,datatypeUsageConfig, false,null, includeDerived,bindingExportConfig, includePrimitive,null);
    ...
    public SerializableDatatype serializeDatatype(DatatypeLink datatypeLink, String prefix,
        ...
        Map<String, Datatype> componentProfileDatatypes, IncludeAutoGenerated includeDerived,BindingExportConfig bindingExportConfig, Boolean includePrimitive) throws DatatypeSerializationException {
        if(datatypeLink!=null && datatypeLink.getId()!=null) {
            ...
            String headerLevel = String.valueOf(3);
            return serializeDatatype(datatype,headerLevel,prefix,position,datatypeUsageConfig, false,null,new IncludeAutoGenerated(),bindingExportConfig, includePrimitive,componentProfileDatatypes);
        }
        return null;
    }

    private SerializableDatatype serializeDatatype(Datatype datatype, String headerLevel, String prefix, Integer position, UsageConfig datatypeUsageConfig, Boolean showInnerLinks, String host, IncludeAutoGenerated includeDerived, BindingExportConfig bindingExportConfig, Boolean includePrimitive, Map<String, Datatype> componentProfileDatatypes) throws
...
//                        }
                        ...
                        try {
                            if (ExportUtil.diplayUsage(component.getUsage(), datatypeUsageConfig)) {
                                if (component.getDatatype() != null && !component.getDatatype().getId().isEmpty()) {
                                	...
                                	}else if (componentProfileDatatypes !=null && componentProfileDatatypes.containsKey(component.getDatatype().getId())) { 
                                   		
                                        	componentDatatype = componentProfileDatatypes.get(component.getDatatype().getId());
                                        	componentDatatypeMap.put(component, componentDatatype);
                ...
                if (datatype.getName().equals("DTM")) {
                    serializedDatatype = new SerializableDateTimeDatatype(id, prefix, String.valueOf(position),
                        ...
                        showConfLength, showInnerLinks, host,filtredBinding,includeDerived);
                } else {
                	if(!datatype.getComponents().isEmpty() || includePrimitive){
                	    serializedDatatype =
                                new SerializableDatatype(id, prefix, String.valueOf(position), headerLevel,
                                    ...
                                    componentTextMap, showConfLength, showInnerLinks, host, filtredBinding,includeDerived, bindingExportConfig);
                	}
	...
	public SerializableDatatype serializeDatatype(Datatype datatype, String host)
      throws DatatypeSerializationException {
		...
		return serializeDatatype(datatype,String.valueOf(0), "1", 1, ExportConfig.getBasicExportConfig(true).getDatatypesExport(), true, host,ExportConfig.getBasicExportConfig(true).getIncludeAutoGenerated(), new BindingExportConfig(), ExportConfig.getBasicExportConfig(true).isIncludePrimitiveDatatype(), null);
	}
}