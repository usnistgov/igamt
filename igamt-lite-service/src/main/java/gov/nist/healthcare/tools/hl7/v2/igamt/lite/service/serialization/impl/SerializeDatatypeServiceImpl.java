...
@Service public class SerializeDatatypeServiceImpl implements SerializeDatatypeService {
    ...
    public SerializableDatatype serializeDatatype(DatatypeLink datatypeLink, String prefix,
        Integer position, UsageConfig datatypeUsageConfig, IncludeAutoGenerated includeDerived, BindingExportConfig bindingExportConfig) throws DatatypeSerializationException {
        if(datatypeLink!=null && datatypeLink.getId()!=null) {
            ...
            return serializeDatatype(datatype,headerLevel,prefix,position,datatypeUsageConfig, false,null,includeDerived, bindingExportConfig);
        }
        return null;
    }
    ...
    public SerializableDatatype serializeDatatype(DatatypeLink datatypeLink, Datatype datatype, String prefix,
        ...
        if(datatype!=null) {
            String headerLevel = String.valueOf(3);
            return serializeDatatype(datatype,headerLevel,prefix,position,datatypeUsageConfig, false,null, new IncludeAutoGenerated(), new BindingExportConfig());
        }
        return null;
    }
    ...
    public SerializableDatatype serializeDatatype(DatatypeLink datatypeLink, String prefix,
        ...
        Map<String, Datatype> componentProfileDatatypes, IncludeAutoGenerated includeDerived,BindingExportConfig bindingExportConfig) throws DatatypeSerializationException {
        if(datatypeLink!=null && datatypeLink.getId()!=null) {
            ...
            String headerLevel = String.valueOf(3);
            return serializeDatatype(datatype,headerLevel,prefix,position,datatypeUsageConfig, false,null,new IncludeAutoGenerated(),bindingExportConfig);
        }
        return null;
    }

    private SerializableDatatype serializeDatatype(Datatype datatype, String headerLevel, String prefix, Integer position, UsageConfig datatypeUsageConfig, Boolean showInnerLinks, String host, IncludeAutoGenerated includeDerived, BindingExportConfig bindingExportConfig) throws
...
//                        }
	...
	public SerializableDatatype serializeDatatype(Datatype datatype, String host)
      throws DatatypeSerializationException {
		return serializeDatatype(datatype,String.valueOf(0), "1", 1, ExportConfig.getBasicExportConfig(true).getDatatypesExport(), true, host,new IncludeAutoGenerated(), new BindingExportConfig());
	}
}