...
@Service public class SerializeDatatypeServiceImpl implements SerializeDatatypeService {
    ...
    public SerializableDatatype serializeDatatype(DatatypeLink datatypeLink, String prefix,
        ...
        if(datatypeLink!=null && datatypeLink.getId()!=null) {
            ...
            return serializeDatatype(datatype,headerLevel,prefix,position,datatypeUsageConfig, false,null,includeDerived, bindingExportConfig,includePrimitive);
        }
        return null;
    }
    ...
    public SerializableDatatype serializeDatatype(DatatypeLink datatypeLink, Datatype datatype, String prefix,
        ...
        if(datatype!=null) {
            String headerLevel = String.valueOf(3);
            return serializeDatatype(datatype,headerLevel,prefix,position,datatypeUsageConfig, false,null, new IncludeAutoGenerated(), new BindingExportConfig(), true);
        }
        return null;
    }
    ...
    public SerializableDatatype serializeDatatype(DatatypeLink datatypeLink, String prefix,
        ...
        if(datatypeLink!=null && datatypeLink.getId()!=null) {
            ...
            String headerLevel = String.valueOf(3);
            return serializeDatatype(datatype,headerLevel,prefix,position,datatypeUsageConfig, false,null,new IncludeAutoGenerated(),bindingExportConfig, includePrimitive);
        }
        return null;
    }

    private SerializableDatatype serializeDatatype(Datatype datatype, String headerLevel, String prefix, Integer position, UsageConfig datatypeUsageConfig, Boolean showInnerLinks, String host, IncludeAutoGenerated includeDerived, BindingExportConfig bindingExportConfig, Boolean includePrimitive) throws
...
//                        }
	...
	public SerializableDatatype serializeDatatype(Datatype datatype, String host)
      throws DatatypeSerializationException {
		...
		return serializeDatatype(datatype,String.valueOf(0), "1", 1, ExportConfig.getBasicExportConfig(true).getDatatypesExport(), true, host,ExportConfig.getBasicExportConfig(true).getIncludeAutoGenerated(), new BindingExportConfig(), ExportConfig.getBasicExportConfig(true).isIncludePrimitiveDatatype());
	}
}