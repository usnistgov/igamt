...
public class SerializableDateTimeDatatype extends SerializableDatatype {
    ...
    public SerializableDateTimeDatatype(String id, String prefix, String position,
        ...
        Map<Component, List<ValueSetOrSingleCodeBinding>> componentValueSetBindingsMap, List<Table> tables, Map<Component, String> componentTextMap, Boolean showConfLength, Boolean showInnerLink, String host,List<ValueSetOrSingleCodeBinding> filtredBinding) {
        super(id, prefix, position, headerLevel, title, datatype, defPreText, defPostText,
            usageNote, constraints, componentDatatypeMap, componentValueSetBindingsMap, tables, componentTextMap,showConfLength, showInnerLink, host, filtredBinding);
