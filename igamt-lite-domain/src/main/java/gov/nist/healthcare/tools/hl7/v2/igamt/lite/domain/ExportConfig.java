...
public class ExportConfig {
	...
	private IncludeAutoGenerated IncludeAutoGenerated= new IncludeAutoGenerated();
	...
	private boolean includeDynamicMapping = false;
	...
	private BindingExportConfig bindingConfig = new BindingExportConfig();
	private boolean includePrimitiveDatatype = true;
	...
	public static ExportConfig getBasicExportConfig(boolean setAllTrue) {
		...
		defaultConfiguration.setBindingConfig(new BindingExportConfig());
		defaultConfiguration.setIncludeAutoGenerated(new IncludeAutoGenerated());
		defaultConfiguration.setIncludeDynamicMapping(true);
		defaultConfiguration.setValueSetColumn(new ColumnsConfig(valueSetsDefaultList));
		defaultConfiguration.setIncludePrimitiveDatatype(true);
	...
	public IncludeAutoGenerated getIncludeAutoGenerated() {
		return IncludeAutoGenerated;
	}

	public void setIncludeAutoGenerated(IncludeAutoGenerated includeAutoGenerated) {
		IncludeAutoGenerated = includeAutoGenerated;
	}

	public BindingExportConfig getBindingConfig() {
		return bindingConfig;
	}

	public void setBindingConfig(BindingExportConfig bindingConfig) {
		this.bindingConfig = bindingConfig;
	}

	public boolean isIncludeDynamicMapping() {
		return includeDynamicMapping;
	}

	public void setIncludeDynamicMapping(boolean includeDynamicMapping) {
		this.includeDynamicMapping = includeDynamicMapping;
	}

	public boolean isIncludePrimitiveDatatype() {
		return includePrimitiveDatatype;
	}

	public void setIncludePrimitiveDatatype(Boolean includePrimitiveDatatype) {
		this.includePrimitiveDatatype = includePrimitiveDatatype;
	}
